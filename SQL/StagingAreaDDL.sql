...
ALTER TABLE "zwrot"
    ADD FOREIGN KEY ("id_transakcji") REFERENCES "transakcja" ("id_transakcji");

ALTER TABLE "zwrot"
    ADD FOREIGN KEY ("id_produktu") REFERENCES "produkt" ("id_produktu");

ALTER TABLE "produkt_ekspozycja"
    ADD FOREIGN KEY ("id_produktu") REFERENCES "produkt" ("id_produktu");

ALTER TABLE "produkt_ekspozycja"
    ADD FOREIGN KEY ("id_ekspozycji") REFERENCES "ekspozycja" ("id_ekspozycji");

ALTER TABLE "produkt_promocja"
    ADD FOREIGN KEY ("id_produktu") REFERENCES "produkt" ("id_produktu");

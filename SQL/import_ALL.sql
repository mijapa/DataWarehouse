...
select * from "ekspozycj_STAG" WHERE ROWNUM <= 5;
...
select * from "produk_STAGE" WHERE ROWNUM <= 5;

whenever sqlerror exit rollback;
begin
  INSERT INTO "produkt" ("id_produktu", "opis", "producent", "marka", "model", "rodzaj_produktu", "kategoria", "cena", "marza_zawarta_w_cenie") 
  SELECT "id_produktu", "opis", "producent", "marka", "model", "rodzaj_produktu", "kategoria", "cena" * (SELECT "przelicznik" from "kurs_walut" where "waluta_z" like 'PLN' and "id_kursu" = 0), "marza_zawarta_w_cenie" FROM "produk_STAGE" ;
  COMMIT;
...
select * from "skle_STAGE" WHERE ROWNUM <= 5;
...
select * from "transakcj_STAGE" WHERE ROWNUM <= 5;
...
select * from "promocj_STAGE" WHERE ROWNUM <= 5;
...
select * from "produkt_promocj_STAGE" WHERE ROWNUM <= 5;
...
select * from "produkt_ekspozycj_STAGE" WHERE ROWNUM <= 5;
...
select * from "sprzedany_produk_STAGE" WHERE ROWNUM <= 5;
...
select * from "zwro_STAGE" WHERE ROWNUM <= 5;
...
select * from "magazy_STAGE" WHERE ROWNUM <= 5;

    ...
    select * from STAGINGAREA."produk_STAGE";
    ...
    begin
        ...
        SELECT "id_produktu", "model", "marka", "producent", "cena"* (select "kurs_walut"."przelicznik" from "kurs_walut" where "id_kursu" = 2), "rodzaj_produktu", "kategoria", "opis", "marza_zawarta_w_cenie" FROM STAGINGAREA."produk_STAGE" ;
        COMMIT;
    ...
    select * from STAGINGAREA."promocj_STAGE" ;
    ...
    select * from STAGINGAREA."skle_STAGE";
    ...
    select * from STAGINGAREA."magazy_STAGE" WHERE ROWNUM <= 100;
    ...
    select * from STAGINGAREA."ekspozycj_STAGE" ;
    ...
    select * from STAGINGAREA."produkt_ekspozycj_STAGE" WHERE ROWNUM <= 100;
    ...
    select * from STAGINGAREA."produkt_promocj_STAGE" ;
    ...
    select * from STAGINGAREA."transakcj_STAGE" ;
    ...
    select * from STAGINGAREA."sprzedany_produk_STAGE";
    ...
    select * from STAGINGAREA."zwrot_STAGE";
